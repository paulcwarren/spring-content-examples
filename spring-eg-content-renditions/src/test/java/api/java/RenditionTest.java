...
@ContextConfiguration(classes = { JpaConfig.class, RenditionTestConfig.class, RenditionsConfiguration.class})
public class RenditionTest {
    ...
    public void testRendition() throws Exception {
    	InputStream is = claimFormStore.getRendition(claim.getClaimForm(), "image/jpg");
